...
**GitHub Repository:** [https://github.com/johnsonlab-ic/sc-eQTL-pipeline](https://github.com/johnsonlab-ic/sc-eQTL-pipeline)
...
- **Average number of genes tested per cell-type:** `r round(avg_genes_tested)`
